                            ...
                            <div class="card">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <button type="button" class="btn mt-2 btn-success btn-fw ml-2"
                                                data-toggle="modal" data-target="#exampleModal"><i
                                                    class="fa fa-file-excel"></i> EXPORT EXCEL</button>
                                        </div>
                                        <div class="col-md-2 mr-5">
                                            <a href="laporan_jadwal_pdf.php" target="_blank">
                                                <button type="button" class="btn mt-2 btn-danger btn-fw ml-2"
                                                    data-toggle="modal" data-target="#exampleModal"><i
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Jl. Kawi 1, Wonotingal, Kec. Candisari, Kota Semarang, Jawa
                                                        Tengah 50252</td>
                                                    <th><label class="badge badge-success badge-pill">Sedang
                                                            Berlangsung</label></th>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>2021-05-25</td>
                                                    ...
                                                    <td><label class="badge badge-info badge-pill">Akan Datang</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
