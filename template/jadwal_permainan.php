                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label class="badge badge-info badge-pill">Sedang Berlangsung</label></td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm btn-icon">
                                                            <i class="fa fa-trash btn-icon-prepend"></i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label class="badge badge-success badge-pill">Selesai</label></td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm btn-icon">
                                                            <i class="fa fa-trash btn-icon-prepend"></i>
                    ...
                    <div class="modal-body">
                      <div class="form-group row">
                        <div class="col-md-6">
                          ...
                          <select name="" id="" class="form-control" onchange="jenis_game(this)">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control jml_pemain" name="" id="">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-md-6">
