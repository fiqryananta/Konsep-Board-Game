          ...
          <li class="nav-item nav-profile">
            <a class="nav-link">
              ...
              <div class="nav-profile-img">
                <img src="http://via.placeholder.com/32x32" alt="image" class="img-xs rounded-circle ml-3">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2020 <a href="https://www.semogajaya.club/" target="_blank">DOLANAN</a>. All rights reserved.</span>
